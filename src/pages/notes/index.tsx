...
const seoDescription = 'All of my thoughts on programming, travelling, and other random stuff.';
...
export default function Notes({ notes, tags }: Props) {
  return (
    <>
      ...
      />
      <PageLayout intro="All of my thoughts on programming, travelling, and other random stuff. Not structured.">
